...
export default function CreateListing() {
  ...
  const storeImage = async (file) => {
    return new Promise((resolve, reject) => {
      ...
      const fielName = new Date().getTime() +  file.name;
      const storageRef = ref(storage,fielName);
    ...
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        <div className="flex flex-col gap-4 flex-1">
          ...
          <textarea type="text" placeholder="Description" className="border p-3 rounded-lg" id="descriptiion" required onChange={handleChange} value={formData.description}/>
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            ...
            <button disabled={uploading} type="button" onClick={handleImageSubmit} className="p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disable:opacity-80">
